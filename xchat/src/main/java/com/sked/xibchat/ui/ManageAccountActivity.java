...
import com.sked.xibchat.ui.adapter.AccountAdapter;
...
public class ManageAccountActivity extends XmppActivity implements OnAccountUpdate {
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if (i == R.id.mgmt_account_publish_avatar) {
            publishAvatar(selectedAccount);
            return true;
        } else if (i == R.id.mgmt_account_disable) {
            disableAccount(selectedAccount);
            return true;
        } else if (i == R.id.mgmt_account_enable) {
            enableAccount(selectedAccount);
            return true;
        } else if (i == R.id.mgmt_account_delete) {
            deleteAccount(selectedAccount);
            return true;
        } else if (i == R.id.mgmt_account_announce_pgp) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        } else if (i == R.id.action_disable_all) {
            disableAllAccounts();

        } else if (i == R.id.action_enable_all) {
            enableAllAccounts();
