...
import com.sked.xibchat.services.XmppConnectionService.OnAccountUpdate;
import com.sked.xibchat.services.XmppConnectionService.OnConversationUpdate;
import com.sked.xibchat.services.XmppConnectionService.OnRosterUpdate;
import com.sked.xibchat.ui.adapter.ConversationAdapter;
...
public class ConversationActivity extends XmppActivity
    ...
    public static final String ACTION_DOWNLOAD = "com.sked.xibchat.action.DOWNLOAD";
            ...
            public void onPresenceSelected() {
                ...
                switch (attachmentChoice) {
                    ...
                    case ATTACHMENT_CHOICE_RECORD_VOICE:
                        ...
                        fallbackPackageId = "com.sked.xibchat.voicerecorder";
                        break;
                    case ATTACHMENT_CHOICE_LOCATION:
                        intent.setAction("com.sked.xibchat.location.request");
                        fallbackPackageId = "com.sked.xibchat.sharelocation";
                        break;
                }
    ...
    protected void attachFileDialog() {
        ...
        if (new Intent("com.sked.xibchat.location.request").resolveActivity(getPackageManager()) == null) {
