...
import com.sked.xibchat.services.AvatarService;
import com.sked.xibchat.services.XmppConnectionService;
import com.sked.xibchat.services.XmppConnectionService.XmppConnectionBinder;
...
public abstract class XmppActivity extends Activity {
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        ...
        } else if (i == R.id.action_accounts) {
            startActivity(new Intent(this, ManageAccountActivity.class));

        } else if (i == android.R.id.home) {
            finish();

        } else if (i == R.id.action_show_qr_code) {
            showQrCode();
            ...
            nfcAdapter.setNdefPushMessageCallback(new NfcAdapter.CreateNdefMessageCallback() {
                ...
                public NdefMessage createNdefMessage(NfcEvent nfcEvent) {
                    return new NdefMessage(new NdefRecord[]{
                            ...
                            NdefRecord.createApplicationRecord("com.sked.xibchat")
                    });
                }
            }, this);
        }
