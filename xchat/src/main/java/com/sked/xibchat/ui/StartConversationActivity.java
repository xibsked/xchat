...
import com.sked.xibchat.entities.ListItem;
import com.sked.xibchat.entities.Presences;
import com.sked.xibchat.services.XmppConnectionService.OnRosterUpdate;
import com.sked.xibchat.ui.adapter.KnownHostsAdapter;
import com.sked.xibchat.ui.adapter.ListItemAdapter;
import com.sked.xibchat.utils.XmppUri;
...
public class StartConversationActivity extends XmppActivity implements OnRosterUpdate, OnUpdateBlocklist {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == R.id.action_create_contact) {
            showCreateContactDialog(null, null);
            return true;
        } else if (i == R.id.action_join_conference) {
            showJoinConferenceDialog(null);
            return true;
        } else if (i == R.id.action_scan_qr_code) {
            new IntentIntegrator(this).initiateScan();
            return true;
        } else if (i == R.id.action_hide_offline) {
    ...
    public static class MyListFragment extends ListFragment {
        ...
        public boolean onContextItemSelected(final MenuItem item) {
            ...
            int i = item.getItemId();
            if (i == R.id.context_start_conversation) {
                activity.openConversationForContact();

            } else if (i == R.id.context_contact_details) {
                activity.openDetailsForContact();

            } else if (i == R.id.context_contact_block_unblock) {
                activity.toggleContactBlock();

            } else if (i == R.id.context_delete_contact) {
                activity.deleteContact();

            } else if (i == R.id.context_join_conference) {
                activity.openConversationForBookmark();

            } else if (i == R.id.context_delete_conference) {
