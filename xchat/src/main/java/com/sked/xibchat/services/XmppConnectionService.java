package com.sked.xibchat.services;
...
import com.sked.xibchat.Config;
import com.sked.xibchat.R;
import com.sked.xibchat.crypto.PgpEngine;
import com.sked.xibchat.entities.Account;
import com.sked.xibchat.entities.Blockable;
import com.sked.xibchat.entities.Bookmark;
import com.sked.xibchat.entities.Contact;
import com.sked.xibchat.entities.Conversation;
import com.sked.xibchat.entities.Downloadable;
import com.sked.xibchat.entities.DownloadablePlaceholder;
import com.sked.xibchat.entities.Message;
import com.sked.xibchat.entities.MucOptions;
import com.sked.xibchat.entities.MucOptions.OnRenameListener;
import com.sked.xibchat.generator.IqGenerator;
import com.sked.xibchat.generator.MessageGenerator;
import com.sked.xibchat.generator.PresenceGenerator;
import com.sked.xibchat.http.HttpConnectionManager;
import com.sked.xibchat.parser.IqParser;
import com.sked.xibchat.parser.MessageParser;
import com.sked.xibchat.parser.PresenceParser;
import com.sked.xibchat.persistance.DatabaseBackend;
import com.sked.xibchat.persistance.FileBackend;
import com.sked.xibchat.ui.UiCallback;
import com.sked.xibchat.utils.CryptoHelper;
import com.sked.xibchat.utils.ExceptionHelper;
import com.sked.xibchat.utils.OnPhoneContactsLoadedListener;
import com.sked.xibchat.utils.PRNGFixes;
import com.sked.xibchat.utils.PhoneHelper;
import com.sked.xibchat.utils.SerialSingleThreadExecutor;
import com.sked.xibchat.utils.Xmlns;
import com.sked.xibchat.xml.Element;
import com.sked.xibchat.xmpp.OnBindListener;
import com.sked.xibchat.xmpp.OnContactStatusChanged;
import com.sked.xibchat.xmpp.OnIqPacketReceived;
import com.sked.xibchat.xmpp.OnMessageAcknowledged;
import com.sked.xibchat.xmpp.OnMessagePacketReceived;
import com.sked.xibchat.xmpp.OnPresencePacketReceived;
import com.sked.xibchat.xmpp.OnStatusChanged;
import com.sked.xibchat.xmpp.OnUpdateBlocklist;
import com.sked.xibchat.xmpp.XmppConnection;
import com.sked.xibchat.xmpp.chatstate.ChatState;
import com.sked.xibchat.xmpp.forms.Data;
import com.sked.xibchat.xmpp.forms.Field;
import com.sked.xibchat.xmpp.jid.InvalidJidException;
import com.sked.xibchat.xmpp.jid.Jid;
import com.sked.xibchat.xmpp.jingle.JingleConnectionManager;
import com.sked.xibchat.xmpp.jingle.OnJinglePacketReceived;
