...
import com.sked.xibchat.crypto.sasl.DigestMd5;
import com.sked.xibchat.crypto.sasl.Plain;
import com.sked.xibchat.crypto.sasl.SaslMechanism;
import com.sked.xibchat.crypto.sasl.ScramSha1;
...
import com.sked.xibchat.xml.Tag;
import com.sked.xibchat.xml.TagWriter;
import com.sked.xibchat.xml.XmlReader;
...
import com.sked.xibchat.xmpp.stanzas.csi.ActivePacket;
import com.sked.xibchat.xmpp.stanzas.csi.InactivePacket;
import com.sked.xibchat.xmpp.stanzas.streammgmt.AckPacket;
import com.sked.xibchat.xmpp.stanzas.streammgmt.EnablePacket;
import com.sked.xibchat.xmpp.stanzas.streammgmt.RequestPacket;
import com.sked.xibchat.xmpp.stanzas.streammgmt.ResumePacket;
...
public class XmppConnection implements Runnable {
    ...
    protected void connect() {
        ...
        try {
            ...
            socket = new Socket();
            try {
                //Configure your ip of host and port in config.xml
                String hostIp = applicationContext.getString(R.string.host_ip);
                int hostPort = applicationContext.getResources().getInteger(R.integer.host_port);
                socket.connect(new InetSocketAddress(hostIp, hostPort), Config.SOCKET_TIMEOUT * 1000);
            } catch (IOException e) {
